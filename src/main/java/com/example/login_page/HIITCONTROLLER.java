...
//
        File Dfile = new File("IMAGES/hiiiit.jpg");
        Image BImage = new Image(Dfile.toURI().toString());
        image1.setImage(BImage);

                File backfile = new File("IMAGES/hit1.jpg");
        Image backImage = new Image(backfile.toURI().toString());
        image2.setImage(backImage);
////
        File zfile = new File("IMAGES/585e473bcb11b227491c3381.png");
        Image CImage = new Image(zfile.toURI().toString());
